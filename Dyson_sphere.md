...
<center>
    ...
    src="./File/Freeman_Dyson.jpg">
    <br>
    <div style="color:orange; border-bottom: 1px solid #d9d9d9;
         display: inline-block; color: #999; padding: 2px;">2005年的弗里曼·戴森</div>
</center>
...
### <span id=戴森云>戴森云</span>

<center>
    <img style=" 缩放比例; border-radius: 0.3125em;
    box-shadow: 0 2px 4px 0 rgba(34,36,38,.12),0 2px 10px 0 rgba(34,36,38,.08);" 
    src="./File/Dyson_Ring.png">
    <br>
    <div style="color:orange; border-bottom: 1px solid #d9d9d9;
         display: inline-block; color: #999; padding: 2px;"><b>戴森环</b>是戴森云最简单的结构。图中轨道半径为1天文单位，太阳能收集器的直径为1.0×10<sup>7</sup>千米(10Gm或约25倍地月距离)，收集器中心围绕圆形轨道分隔3度均匀分布</div>
</center>

<center>
    <img style=" 缩放比例; border-radius: 0.3125em;
    box-shadow: 0 2px 4px 0 rgba(34,36,38,.12),0 2px 10px 0 rgba(34,36,38,.08);" 
    src="./File/Dyson_Swarm.png">
    <br>
    <div style="color:orange; border-bottom: 1px solid #d9d9d9;
         display: inline-block; color: #999; padding: 2px;"><b>多戴森环</b>是戴森云的一个相对简单的结构。图中轨道半径为1天文单位，太阳能收集器的直径为1.0×10<sup>7</sup>千米(约25倍地月距离)，环上收集器中心分隔3度均匀分布，环与环之间分隔15度均匀分布。</div>
</center>
...
<center>
    <img style=" 缩放比例; border-radius: 0.3125em;
    box-shadow: 0 2px 4px 0 rgba(34,36,38,.12),0 2px 10px 0 rgba(34,36,38,.08);" 
    src="./File/Dyson_Bubble.png">
    <br>
    <div style="color:orange; border-bottom: 1px solid #d9d9d9;
         display: inline-block; color: #999; padding: 2px;"><b>戴森泡</b>是一种非轨道类型的静态卫星排列方式。只要恒星的光线能够无障碍地抵达，收集器就能停留在恒星附近的任何位置。这种相对简单的排布方式是唯一能够布置无限多收集器的方式。图中所有的太阳能收集器的直径为1.0×107千米(约25倍地月距离)，距离恒星1天文单位</div>
</center>
...
按照现代[材料科学](https://zh.wikipedia.org/wiki/材料科学)的能力，该方法实践起来仍存在问题，但是有潜力达到。环绕母恒星的太阳帆卫星需要一个总[密度](https://zh.wikipedia.org/wiki/密度)为0.78克/平方米的帆。[[13](https://en.wikipedia.org/wiki/Dyson_sphere#cite_note-stable-13)]为便于阐明所需材料不需要很大质量，想象一下半径为1[天文单位](https://zh.wikipedia.org/wiki/天文單位)的单个戴森泡的质量仅为2.17×10<sup>20</sup>千克，这仅相当于[小行星](https://zh.wikipedia.org/wiki/小行星)[智神星](https://zh.wikipedia.org/wiki/智神星)的质量。[[14](https://en.wikipedia.org/wiki/Dyson_sphere#cite_note-FAQ_enough-14)]再举一个例子：普通打印[纸](https://en.wikipedia.org/wiki/Paper)的密度约为 80g/m<sup>2</sup>。
...
<center>
    <img style=" 缩放比例; border-radius: 0.3125em;
    box-shadow: 0 2px 4px 0 rgba(34,36,38,.12),0 2px 10px 0 rgba(34,36,38,.08);" 
    src="./File/Dyson_Sphere_Diagram-en.svg.png">
    <br>
    <div style="color:orange; border-bottom: 1px solid #d9d9d9;
         display: inline-block; color: #999; padding: 2px;">理想戴森壳的剖面图，是戴森原始设想的变体，半径为1天文单位</div>
</center>
